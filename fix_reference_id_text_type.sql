-- Fix reference_id TEXT type mismatch - FINAL SOLUTION
...
BEGIN
  ...
  -- CRITICAL: reference_id is TEXT, so convert UUID to TEXT
  SELECT COUNT(*)
  INTO v_existing_earning_count
  FROM wallet_transactions wt
  WHERE wt.reference_id = p_request_id::text  -- Convert UUID to TEXT
  ...
  INSERT INTO wallet_transactions (
    ...
    p_request_id::text,  -- Convert UUID to TEXT for reference_id
    NOW()
...
SELECT 'REFERENCE_ID TEXT TYPE FIXED - FINAL SOLUTION DEPLOYED' as status;
