-- FIX: Remove ON CONFLICT clause that requires non-existent constraint
-- Use IF EXISTS checks instead of relying on database constraints
-- Simpler, safer duplicate prevention logic
