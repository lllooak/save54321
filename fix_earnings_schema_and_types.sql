-- Fix for both UUID/text type mismatch AND earnings table schema mismatch
-- Remove fan_id from earnings insert (doesn't exist in table)
...
BEGIN
  ...
  -- Create earnings record - FIXED: Remove fan_id (doesn't exist in table)
